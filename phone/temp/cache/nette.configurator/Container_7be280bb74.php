<?php
// source: /var/www/project/config/common.neon
// source: /var/www/project/config/services.neon
// source: array
...
class Container_7be280bb74 extends Nette\DI\Container
{
	...
	{
		return new Nette\Caching\Storages\SQLiteJournal('/var/www/project/temp/cache/journal.s3db');
	}


	public function createServiceCache__storage(): Nette\Caching\Storage
	{
		return new Nette\Caching\Storages\FileStorage('/var/www/project/temp/cache', $this->getService('cache.journal'));
	}


	public function createServiceContainer(): Container_7be280bb74
	{
		return $this;
	}
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\LatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\LatteFactory {
			public function __construct(
				private Container_7be280bb74 $container,
			) {
			}
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('/var/www/project/temp/cache/latte');
